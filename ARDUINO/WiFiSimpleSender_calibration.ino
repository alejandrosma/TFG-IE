...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    Serial.print("Bx:\t");
    Serial.print((sqrt(pow(Bx0,2)+pow(By0,2)+pow(Bz0,2)) - sqrt(pow(Bx1,2)+pow(By1,2)+pow(Bz1,2))));
    Serial.print("\tBy:\t");
    Serial.println((sqrt(pow(Bx2,2)+pow(By2,2 )+pow(Bz2,2)) - sqrt(pow(Bx3,2)+pow(By3,2)+pow(Bz3,2))));
    Serial.println("------------------------------------------------");
    ...
    mqttClient.print((sqrt(pow(Bx0,2)+pow(By0,2)+pow(Bz0,2)) - sqrt(pow(Bx1,2)+pow(By1,2)+pow(Bz1,2))));
    mqttClient.print("\t");
    mqttClient.print((sqrt(pow(Bx2,2)+pow(By2,2 )+pow(Bz2,2)) - sqrt(pow(Bx3,2)+pow(By3,2)+pow(Bz3,2))));
